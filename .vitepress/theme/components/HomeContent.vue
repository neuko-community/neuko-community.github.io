...
import OfficialArticles from './OfficialArticles.vue'
</script>
...
<template>
  <div class="home-content">
    ...
    <div class="features-grid">
      <a v-for="feature in homeConfig.features" :key="feature.title" :href="feature.link"
        class="neuko-card feature-card">
        <h4>{{ feature.title }}</h4>
        <p>{{ feature.desc }}</p>
      </a>
    </div>
    ...
    <div class="video-intro-section">
      ...
      <div class="video-embed">
        <video class="neuko-video-embed" controls playsinline :poster="homeConfig.videoIntro.poster">
    ...
    <div class="content-grid">
      ...
      <div class="neuko-card large-item">
        ...
        <div class="card-content">
          <img v-if="homeConfig.howItStarted.image" :src="withBase(homeConfig.howItStarted.image)" alt="How it Started"
            class="section-img" />
      ...
      <div class="neuko-card">
        ...
        <div class="card-content">
          <div class="transmission-preview">
            <img :src="withBase(homeConfig.latestTransmission.image)" alt="Transmission Thumbnail"
              class="transmission-img" />
            <div class="transmission-info">
              <h4>{{ homeConfig.latestTransmission.subTitle }}</h4>
              <p>{{ homeConfig.latestTransmission.desc }}</p>
              <a :href="homeConfig.latestTransmission.link"
                class="watch-btn">{{ homeConfig.latestTransmission.cta }}</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="community-section">
      <h3 class="neuko-section-title">{{ homeConfig.communitySpotlight.title }} <a
          :href="homeConfig.communitySpotlight.curatorLink" target="_blank"
          class="highlight-link">{{ homeConfig.communitySpotlight.curator }}</a></h3>
      <div class="community-grid">
        <div v-for="id in homeConfig.communitySpotlight.tweetIds" :key="id" class="neuko-card tweet-card">
...
.section-tag {
  ...
  padding: 0;
  /* Removed padding to align with text */
  margin-bottom: 0.25rem;
  /* Reduced margin to be closer to title */
